...
export async function POST(request: Request) {
  return handleRoute(async () => {
    ...
    const agrDoc = {
      ...
      resource_snapshot_municipio: resource.municipio ?? null,
      resource_snapshot_lat: resource.latitude ?? null,
      resource_snapshot_lng: resource.longitude ?? null,
      resource_snapshot_location_notes: resource.location_notes ?? null,
      resource_snapshot_modalidad: resource.modalidad ?? null,
      resource_snapshot_cantidad: resource.cantidad ?? null,
      resource_snapshot_unidad: resource.unidad ?? null,
      resource_snapshot_condicion: resource.condicion ?? null,
      resource_snapshot_disponibilidad: resource.disponibilidad ?? null,
      resource_snapshot_precio: resource.precio_referencia ?? null,
      resource_snapshot_duracion: resource.duracion_prestamo ?? null,
      resource_snapshot_garantia: resource.garantia ?? null,
      resource_snapshot_ofrece: resource.ofrece ?? null,
      resource_snapshot_recibe: resource.recibe ?? null,
      created_at: now,
      updated_at: now,
    }
